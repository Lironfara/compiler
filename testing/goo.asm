...
.L_tc_recycle_frame_done_0050:
	...
	leave
	ret AND_KILL_FRAME(1)
	jmp .L_lambda_opt_end_000a	; new closure is in rax
...
.L_if_end_0030:
	leave
	ret AND_KILL_FRAME(2)
	jmp .L_lambda_opt_end_000b	; new closure is in rax
...
.L_tc_recycle_frame_done_0076:
	...
	leave
	ret AND_KILL_FRAME(1)
	jmp .L_lambda_opt_end_000c	; new closure is in rax
...
.L_if_end_004a:
	leave
	ret AND_KILL_FRAME(2)
	jmp .L_lambda_opt_end_000d	; new closure is in rax
...
.L_tc_recycle_frame_done_00a1:
	...
	leave
	ret AND_KILL_FRAME(2)
	jmp .L_lambda_opt_end_000e	; new closure is in rax
...
.L_tc_recycle_frame_done_00ab:
	...
	leave
	ret AND_KILL_FRAME(1)
	jmp .L_lambda_opt_end_000f	; new closure is in rax
...
.L_tc_recycle_frame_done_00b1:
	...
	leave
	ret AND_KILL_FRAME(1)
	jmp .L_lambda_opt_end_0010	; new closure is in rax
...
.L_if_end_005b:
	...
	mov rbx, qword[rsp+8*2]	 ;rbx holds the lexical enviroment of h
	mov qword[rbp + 8*2],rbx
	mov qword[rbp + 8*3], 5	 ;n turns to m
	mov rdi,0
...
.L_tc_recycle_frame_done_00b9:
	...
	leave
	ret AND_KILL_FRAME(2)
	jmp .L_lambda_opt_end_0011	; new closure is in rax
...
.L_tc_recycle_frame_done_00c3:
	...
	leave
	ret AND_KILL_FRAME(2)
	jmp .L_lambda_opt_end_0012	; new closure is in rax
...
.L_lambda_simple_arity_check_ok_007e:
	...
	mov rbx, qword[rsp+8*2]	 ;rbx holds the lexical enviroment of h
	mov qword[rbp + 8*2],rbx
	mov qword[rbp + 8*3], 4	 ;n turns to m
	mov rdi,0
...
.L_tc_recycle_frame_done_00cc:
	...
	leave
	ret AND_KILL_FRAME(2)
	jmp .L_lambda_opt_end_0013	; new closure is in rax
...
.L_tc_recycle_frame_done_00d4:
	...
	leave
	ret AND_KILL_FRAME(2)
	jmp .L_lambda_opt_end_0014	; new closure is in rax
...
.L_tc_recycle_frame_done_00d8:
	...
	leave
	ret AND_KILL_FRAME(2)
	jmp .L_lambda_opt_end_0015	; new closure is in rax
...
.L_tc_recycle_frame_done_00e0:
	...
	leave
	ret AND_KILL_FRAME(1)
	jmp .L_lambda_opt_end_0016	; new closure is in rax
...
.L_tc_recycle_frame_done_00f7:
	...
	leave
	ret AND_KILL_FRAME(1)
	jmp .L_lambda_opt_end_0017	; new closure is in rax
...
.L_tc_recycle_frame_done_00fc:
	...
	leave
	ret AND_KILL_FRAME(1)
	jmp .L_lambda_opt_end_0018	; new closure is in rax
...
L_code_ptr_bin_apply:
        enter 0, 0
        cmp COUNT, 2
        jl L_error_arg_count_3    ; Need at least 2 arguments
