...
L_constants:
	...
	dq 1
	db 0x67
free_var_0:	; location of f
	dq .undefined_object
.undefined_object:
	db T_undefined
	dq L_constants + 42

free_var_1:	; location of f?
	dq .undefined_object
.undefined_object:
	db T_undefined
	dq L_constants + 21

free_var_2:	; location of g
	dq .undefined_object
.undefined_object:
	db T_undefined
	dq L_constants + 83

free_var_3:	; location of g?
	dq .undefined_object
.undefined_object:
	db T_undefined
	dq L_constants + 72

free_var_4:	; location of x
	dq .undefined_object
.undefined_object:
	db T_undefined
	dq L_constants + 32

free_var_5:	; location of y
	dq .undefined_object
.undefined_object:
	db T_undefined
	dq L_constants + 52

free_var_6:	; location of z
	dq .undefined_object
.undefined_object:
	db T_undefined
	dq L_constants + 62
...
main:
	...
	mov rax, qword [free_var_4]	; free var x
	cmp byte [rax], T_undefined
	je L_error_fvar_undefined
	push rax
	push 1	; arg count
	mov rax, qword [free_var_1]	; free var f?
	cmp byte [rax], T_undefined
	je L_error_fvar_undefined
	...
	je .L_if_else_0002
	; preparing a non-tail-call
	mov rax, qword [free_var_5]	; free var y
	cmp byte [rax], T_undefined
	je L_error_fvar_undefined
	push rax
	push 1	; arg count
	mov rax, qword [free_var_0]	; free var f
	cmp byte [rax], T_undefined
	je L_error_fvar_undefined
	cmp byte [rax], T_closure
	jne L_error_non_closure
	...
	; preparing a non-tail-call
	mov rax, qword [free_var_6]	; free var z
	cmp byte [rax], T_undefined
	je L_error_fvar_undefined
	push rax
	push 1	; arg count
...
.L_if_else_0002:
	...
	push rax
	push 1	; arg count
	mov rax, qword [free_var_3]	; free var g?
	cmp byte [rax], T_undefined
	je L_error_fvar_undefined
	cmp byte [rax], T_closure
	jne L_error_non_closure
	...
	push rax
	push 1	; arg count
	mov rax, qword [free_var_2]	; free var g
	cmp byte [rax], T_undefined
	je L_error_fvar_undefined
	cmp byte [rax], T_closure
	jne L_error_non_closure
